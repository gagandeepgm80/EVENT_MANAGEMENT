        ...
        <div class="container">
            <div class="row">
                ...
                <div id="menu" class="col-lg-8 col-md-9 d-none d-md-block nav-item">
                    <ul >
                        <li><a href="#" ></a><h2> You are one step ahead to book event <% if (session.getAttribute("uname") != null) {%><span style="color: #00ab9f;"><%=session.getAttribute("uname")%></span> <%}%> </h2></li>
                    </ul>
                </div>
...
ArrayList<EventsData> al = r.get_eventinfo(request.getParameter("event_category"));
Iterator<EventsData> it = al.iterator();
while (it.hasNext()) {
    EventsData s = it.next();
%>
<br><br><br>
        ...
        <div id="imageCarousel" class="carousel slide" data-ride="carousel">
            <div class="carousel-inner">
                <div class="carousel-item active">
                    <img src="gallery/<%=s.getImg1()%>" alt="Image 1">
                </div>
                <div class="carousel-item">
                    <img src="gallery/<%=s.getImg2()%>" class="d-block w-100" alt="Image 2">
                </div>
                <div class="carousel-item">
                    <img src="gallery/<%=s.getImg3()%>" class="d-block w-100" alt="Image 3">
                </div>
            </div>
...
<!--        <h3> <%=s.getName()%></h3>
    ...
    <div class="payment-side">
        <div class="payment-card">
            ...
            <a href="FinalForm.jsp?event_id=<%= s.getId() %>"><button>Book Now</button></a>
