    ...
    <body class="login"style="padding: 80px 0; ">
        <div class="row">
            <div class="main-login col-xs-10 col-xs-offset-1 col-sm-8 col-sm-offset-2 col-md-4 col-md-offset-4">
                ...
                <center><h2><a href="index.jsp" >SMS</a> Event Management</h2></center>
                <div class="box-login" >
                    <center><h3><% if (request.getAttribute("status") != null) {%>
                            <div id="msg"> <%= request.getAttribute("status")%></div><%}%></h3></center>
                        ...
                        <fieldset style="font-size:   25px;">
                            ...
                            <div class="form-group">
                                <span class="input-icon">
                                    <input type="text" class="form-control" name="mailId" placeholder="Username">
                            ...
                            <div class="form-group form-actions">
                                <span class="input-icon">
                                    <input type="password" class="form-control password" name="conPass" placeholder="Confirm Password">
                                    <i class="fa fa-lock"></i>
                                </span>
                            </div>

                            <div class="form-actions">
                                <input type="submit" class="btn btn-primary pull-right" value="Change" name="reset">
